...
| Runner | `runner/` | Local eve project the person installs; bridge server on `127.0.0.1:4310` | placeholder — arrives in P02 |
| Extension | `extension/` | Chrome MV3 extension: capture, side panel, tab groups | placeholder — arrives in P07 |
| Workflow package | `packages/job-assistant/` | `workflow.json`, skills, schemas, templates, fixtures for the job-application assistant | placeholder — arrives in P01 |
