...
- [x] P3.E — P07.C Extension: sessions, tab group, side panel, the nine gates — spec P07; blocked by P3.C, P2.E. Done 2026-09-25 (manual session), PR #24 (squash 98fa482).
...
- [x] P4.B — P10.B Upgrade flow and full acceptance run — spec P10; blocked by every other item. Done 2026-09-25 (manual session), PR #25 (squash 50016c3).
