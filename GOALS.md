...
- [ ] P3.F — P02.1 Runner follow-ups — HEAD must not spend the one-time sign-in link; a unit test for an error inside the /pair queue; spec P02.1-runner-followups.md; blocked by P1.D. Planned for iter 005.
