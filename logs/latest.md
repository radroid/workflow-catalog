...
- **Rounds 3 and 4:** round 3 gave Y1–Y8, and the same escalation did revision 3 (00ff33e). Round 4 gave REVISE 2 + UI REVISE 1, which became Z1–Z4 (`logs/handoff/P05-round-4-review.md`). Revision 4 is done at 451398e (CI 36100537630 green). Round 5 (narrow, the same reviewer and critic) started about 06:10; older-kind gaps go to P05.1.
